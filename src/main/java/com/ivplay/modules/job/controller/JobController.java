package com.ivplay.modules.job.controller;
...
import com.ivplay.common.security.xss.XssHttpServletRequestWrapper;
import com.ivplay.modules.job.model.ScheduleJob;
import com.ivplay.modules.job.service.ScheduleJobService;
...
public class JobController extends BaseController{
    ...
    public String view(@PathVariable("id")Long id, ModelMap modelMap){
        ...
        if(null != model){
            //创建者
            Admin userCreate = userService.findById(model.getCreateBy());
            if(null != userCreate){
                model.setCreateByName(userCreate.getUsername());
            }
            //修改者
            Admin userModify = userService.findById(model.getModifyBy());
            if(null != userModify){
