...
import com.ivplay.common.validator.group.Update;
...
import com.ivplay.modules.sys.service.PermissionService;
import com.ivplay.modules.sys.service.RolePermissionService;
...
public class RoleController extends BaseController{
    ...
    public ResponseEntity<String> delete(@PathVariable("id") Long id) {
        ...
        AdminRole userRole = userRoleService.findByUserIdAndRoleId(null, id);
        if(null != userRole){
