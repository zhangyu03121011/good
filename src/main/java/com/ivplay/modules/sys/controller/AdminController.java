package com.ivplay.modules.sys.controller;

import com.github.pagehelper.PageInfo;
import com.ivplay.common.annotation.OperationLog;
import com.ivplay.common.base.controller.BaseController;
import com.ivplay.common.security.token.FormToken;
...
public class AdminController extends BaseController {
    ...
    public String list(
        ...
        try {
            ...
            PageInfo<Admin> pageInfo = userService.findPage(pageNum, PAGESIZE, username, startTime, endTime);
    ...
    public ResponseEntity<String> delete(@PathVariable("id") Long id) {
        ...
        Admin user = userService.findById(id);
        if (null == user) {
    ...
    public ResponseEntity<Void> deleteBatch(@PathVariable("ids") List<Object> ids) {
        ...
        userService.deleteByCondition(Admin.class, "id", ids);
    ...
    public ModelMap saveUser(Admin user, Long roleId) throws Exception {
    ...
    public ModelMap updateUser(@PathVariable("id") Long id, Admin user, Long oldRoleId, Long roleId) throws Exception {
        ModelMap messagesMap = new ModelMap();
        log.debug("编辑管理员参数! id= {}, user = {}", id, user);

        Admin u = userService.findById(id);
        if (null == u) {
    ...
    public Boolean isExist(Long id, String username) throws Exception {
        ...
        Admin record = userService.findByUserName(username);
